...
function Home(){
    ...
    return (
        ...
        <div className='flex flex-col justify-center h-[100vh] w-full bg-green-200'>
            ...
            add a task <input ref={input} className='m-2 border-2 border-gray-500 rounded-md' placeholder='add your tasks' onChange={(e)=>setTask(e.target.value)}/>
            <button className='bg-[rgb(59,255,180)] p-1 rounded-md' onClick={()=>{dispatch(addTodo(Task)); input.current.value=''; setTask('');}}>Add it now!</button>
            </div>
